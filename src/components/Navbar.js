    ...
    <div className="md:flex items-center justify-center w-screen bg-stone-700 ">
      <div className="flex flex-col md:flex-row md:mx-6 gap-x-60 sm:gap-x-5 xl:gap-x-40  ">
        ...
        <NavLink to="/register" className="my-1 text-3xl text-gray-200 font-medium hover:text-yellow-600 hover:scale-125  transition duration-400 md:mx-4 md:my-0" href="#">Register
          ...
          <button onClick={handleLogout} className=" bg-yellow-600 px-2 border-2 rounded-md border-black "> Log Out</button>
        {/* This is the cart icon */}
      <div className="flex justify-center md:block relative 2xl:left-60 xl:left-20 sm:left-20 ">
